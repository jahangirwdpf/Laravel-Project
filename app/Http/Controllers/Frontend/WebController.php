...
class WebController extends Controller
{
    public function index()
    {
            ...
            ->where('status',1)->get()->sortDesc();
            $bnews=DB::table('news')->where('breaking_news',1)->where('status',1)->get()->sortDesc(); 
    ...
    public function single()
    {
        $category = DB::table('category')->get();
            ...
            // return dd($newses);
        return view('layouts.singlePost', compact('newses', 'bigThumbnail', 'firstThumbnail', 'category', 'firstSection', 'bnews', 'secondSection'));
    }
}
