                        ...
                        <div class="modal-body">
                            <form class="forms-sample" action="{{url('addDiv')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="division" placeholder="division" name="div_name_en" required="">
                                    <label for="category">Division Name Bangla</label>
                                    <input type="text" class="form-control" id="division" placeholder="division" name="div_name_bn" required="">
                                </div>
