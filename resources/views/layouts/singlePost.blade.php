            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container-fluid">
                    ...
                    <nav class="classy-navbar justify-content-between" id="newsboxNav">
                        <!-- Nav brand -->
                        <a href="index.html" class="nav-brand"><img src="{{asset('contents/frontend')}}/img/core-img/logo.png" alt=""></a>
                        <!-- Navbar Toggler -->
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                ...
                                <div class="header-add-area">
                                    <a href="#">
                                       <img src="{{asset('contents/frontend')}}/img/bg-img/add.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <!-- Nav End -->
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="{{asset('contents/frontend')}}/img/bg-img/32.jpg" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                ...
                                <ol class="children">
                                    <li class="single_comment_area">
                                        ...
                                        <div class="comment-content d-flex">
                                            <!-- Comment Author -->
                                            <div class="comment-author">
                                                <img src="{{asset('contents/frontend')}}/img/bg-img/33.jpg" alt="author">
                                            </div>
                                            <!-- Comment Meta -->
                                            <div class="comment-meta">
                                                <div class="d-flex">
